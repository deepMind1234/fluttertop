...
class _DashboardViewState extends State<DashboardView> {
                      ...
                      Expanded(
                        ...
                        child: Column(
                          children: [
                            ...
                            // Current Stats Grid (Static Matrix Structure)
                            Expanded(child: _buildMetricsGrid(context, state)),
                          ],
                        ),
                      ),
                      const SizedBox(width: 16),
  ...
  Widget _buildMetricsGrid(BuildContext context, SystemState state) {
    // Definitive Static Grid to avoid 'ParentDataWidget' errors
    return Column(
      children: [
        Expanded(
          child: Row(
              ...
              Expanded(
                child: BaseMetricCard(
                  ...
                  value: state.disk != null
                      ...
                      : 'N/A',
                  subtitle: state.disk != null ? 'Read / Write' : null,
                ),
              ),
            ],
          ),
        ...
        Expanded(
          child: Row(
            ...
            children: [
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8),
                      Expanded(
                        child: CpuCoreHeatmap(cores: state.cpu?.cores ?? []),
                      ),
                    ],
                  ),
                ),
              ...
              const SizedBox(width: 12),
              Expanded(child: GpuMetricCard(state: state)),
              const SizedBox(width: 12),
              Expanded(child: NetworkMetricCard(state: state)),
            ],
          ),
        ),
        const SizedBox(height: 12),
        Expanded(
          child: Row(
            ...
            children: [
              ...
              const SizedBox(width: 12),
              Expanded(child: ExternalDriveMetricCard(state: state)),
              const SizedBox(width: 12),
              Expanded(child: StoragePieChartCard(state: state)),
            ],
          ),
        ),
      ],
